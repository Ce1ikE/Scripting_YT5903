...
Geef een lijst weer van alle eventlogs die meerdere dagen worden bijgehouden.

#>

Get-EventLog -LogName * | Get-Member # Property => MinimumRetentionDays

Get-EventLog -LogName * | Where-Object -Property MinimumRetentionDays -GT 1
