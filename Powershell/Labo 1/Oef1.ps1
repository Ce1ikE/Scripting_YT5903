...
Controleer welke powershell versie is geïnstalleerd op je computer. Update vervolgens de powershell help functies 
(update-help powershell als administrator uitvoeren als je hiermee klaar bent open dan terug een shell als gewone 
gebruiker!) 

#>

$PSVersionTable.PSVersion
Update-Help # Only as Admin !!