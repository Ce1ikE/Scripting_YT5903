...
Schrijf een eerste PowerShell scriptje dat dit alles in één keer wegschrijft naar een tekstbestand
...
New-Item -Path $Path -Name TestFileEX6.txt -ItemType file

ipconfig.exe > $Path/TestFileEX6.txt
ROUTE.EXE Print -4 >> $Path/TestFileEX6.txt
HOSTNAME.EXE >> $Path/TestFileEX6.txt