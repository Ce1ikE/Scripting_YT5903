...
Wanneer je de help van een bepaalde functie opvraagt, merk je dat deze altijd wordt weergegeven in je 
commandline. Dit is niet altijd even handig.
Het kan echter ook anders. Zoek uit hoe.

#>

# For example the "get-command" is used
