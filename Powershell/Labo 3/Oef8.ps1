...
Vraag alle processen op die beginnen met de eerste letter van je voornaam. Indien deze er niet zijn, neem dan de 
volgende letter, tot je een lijst te zien krijgt

#>

$FirstLetter = "e"

Get-Process | Where-Object -Property ProcessName -Like "$FirstLetter*"
